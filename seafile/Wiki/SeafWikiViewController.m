...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _moreButton.hidden = YES; // Hidden until wiki management features are implemented
...
- (void)configureWithWiki:(SeafWikiInfo *)wiki {
    ...
    // moreButton stays hidden until wiki management features (rename/delete/publish) are implemented

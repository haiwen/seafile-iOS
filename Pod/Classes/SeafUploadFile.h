...
@class SeafUploadFileManager;
@class SeafUploadStateManager;
...
@property (nonatomic, strong) SeafUploadFileManager *fileManager;
@property (nonatomic, strong) SeafUploadStateManager *stateManager;
@property (nonatomic, strong) SeafAssetManager *assetManager;
@property (nonatomic, strong) SeafPreviewManager *previewManager;
